...
export default function LoginPage() {
  ...
  // Google Login
// Google Login - Updated to handle first-time registration
const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (axios.isAxiosError(error) && error.response?.status === 404) {
        ...
        await axios.post(`${API_URL}/auth/register`, {
          ...
          // No referral code for Google signups unless you want to implement it
        });
 ...
 <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* 🔥 AnimatePresence to swap between form & loader */}
  ...
  style={{
    boxShadow: "0 0 5pxrgb(98, 155, 88), 0 0 10pxrgb(118, 175, 108), 0 0 15pxrgb(85, 137, 75), 0 0 20px #0f3d24, 0 0 35px #39ff14, 0 0 40px #39ff14",
  }}
>
