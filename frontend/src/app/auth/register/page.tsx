...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (referralFromLink) {
      setForm((prev) => ({ ...prev, referralCode: referralFromLink }));
    }
  }, [referralFromLink]);
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const actionCodeSettings = {
        url: `${window.location.origin}/auth/verified`, // dynamically uses current domain
      ...
      // 🎉 Trigger fire effect on success
      setShowFireEffect(true);
  
      // Hide fire effect after 3s
 ...
 <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        {[...Array(5)].map((_, i) => (
          <motion.div
            ...
            style={{ 
              filter: "blur(1px)",
              boxShadow: "0 0 20px 2pxrgb(0, 255, 0)"
            }}
          />
        ))}
      </div>
      ...
      <motion.form
        ...
        className="relative bg-[#0f3d24]/90 p-8 rounded-3xl w-full max-w-lg shadow-[0_0_25px_#39ff14] border border-green-500 backdrop-blur-lg z-10"
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full p-2 rounded-xl bg-[#102a24] text-white placeholder-gray-400 
                 ring-1 ring-green-700 focus:ring-2 focus:ring-green-500 outline-none"
            />
          </div>
          <div className="flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-3 sm:mt-4">
          <div className="flex flex-col">
            ...
            <PhoneInput
              ...
              inputClass="!w-full !h-[42px] !p-2 !pl-14 !rounded-xl !bg-[#102a24] !text-white !placeholder-gray-400 
              !ring-1 !ring-green-700 focus:!ring-2 focus:!ring-green-500 !outline-none"
  ...
  >
    <motion.div
      ...
      style={{
        ...
        left: "50%",
        transformOrigin: "0% 0%",
        boxShadow: "0 0 10px 2pxrgb(0, 255, 21), 0 0 20px 5px #ff5500"
      }}
      animate={{
        x: [-60, 60, 60, -60, -60],
        y: [-60, -60, 60, 60, -60],
