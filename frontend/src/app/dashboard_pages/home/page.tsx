...
export default function ProfilePage() {
  ...
  const deposits = [
    { name: "User", amount: 500, currency: "USDT" },
    { name: "Shani", amount: 380, currency: "USDT" },
    { name: "Amal", amount: 250, currency: "USDT" },
    { name: "Nila", amount: 700, currency: "USDT" },
    { name: "kasu", amount: 500, currency: "USDT" },
    { name: "Shika", amount: 380, currency: "USDT" },
    { name: "sham", amount: 250, currency: "USDT" },
    { name: "znima1", amount: 700, currency: "USDT" },
  ];
  ...
  return (
    ...
    <div className="min-h-screen rounded-3xl text-black bg-gray-950 p-4 relative overflow-hidden">
    {/* Hero Section */}
    <div
      className="relative rounded-3xl h-[35vh] w-full bg-cover bg-center overflow-hidden"
      style={{
        backgroundImage: "url('/home.jpg')",
      }}
    >
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/60 to-gray-950/90"></div>
      <div className="absolute inset-0 bg-radial-gradient from-emerald-500/20 to-transparent animate-pulse-slow"></div>
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-4">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 drop-shadow-[0_0_15px_rgba(0,255,255,0.7)]">
    ...
    <div className="max-w-6xl mx-auto px-4 mt-6">
      ...
      <button
  onClick={() => router.push("/about")} // <-- navigate to new page
  className="flex-1 px-5 py-4 rounded-2xl bg-gray-800/80 backdrop-blur-md border border-white/10
             hover:bg-gray-700/80 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-gray-900/40"
>
  <Building2 size={20} color={iconColors.info} />
  <span className="text-sm font-medium text-white/90">Company Profile</span>
</button>


        <button
          onClick={handleInvite}
          className="flex-1 px-5 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-cyan-500
    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      ...
      >
        {[
          ...
          { icon: FiUpload, label: "Withdraw", color: "from-green-500 to-teal-500" },
        ].map((action, index) => (
          <motion.button
            key={action.label}
            whileHover={{ scale: 1.02, y: -2, boxShadow: "0px 8px 16px rgba(0,0,0,0.2)" }}
            whileTap={{ scale: 0.98 }}
            className={`bg-gradient-to-br ${action.color} rounded-3xl p-6 text-white shadow-md transition-all duration-300`}
          >
        ...
        <div className="divide-y divide-white/5">
          {Object.values(market).map((coin) => {
            ...
            return (
              <motion.div
                key={coin.symbol}
                className="flex items-center justify-between py-4 px-3 rounded-xl cursor-pointer"
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white/80 text-sm uppercase tracking-wide">
